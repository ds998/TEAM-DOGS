...
<body>
    <div class="header">
        <nav class="navbar bg-dark navbar-dark">
            <a class="navbar-brand" href="<?php echo base_url('game/Game.html'); ?>">
            ...
            <div class="collapse navbar-collapse" id="navbarElements">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url('game/Game.html'); ?>">Play</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url('decklab/Decklab.html'); ?>">Make Ruleset</a>
                    </li>
                    <li class="nav-item">
