                ...
                <li class="nav-item">
                    <?php
                        if ($_SESSION['user']->isGuest) {
                          echo "<a class='nav-link' href='<?php echo site_url('Controller/login_page'); ?>Login</a>";
                        }
                    ?>
                    </li>
                    <li class="nav-item">
                    <?php
                        if ($_SESSION['user']->isGuest) {
                          echo "<a class='nav-link' href='<?php echo site_url('UserController/register'); ?>Register</a>";
                        }
                    ?>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">List All Decks</a>
                    </li>
                    <li class="nav-item">
                    <?php
                        if (!$_SESSION['user']->isGuest) {
                          echo "<a class='nav-link' href='<?php echo site_url('UserController/register'); ?>Saved Decks</a>";
                        }
                    ?>
                    </li>
                    <li class="nav-item">
                    <?php
                        if (!$_SESSION['user']->isGuest) {
                          echo "<a class='nav-link' href='<?php echo site_url('UserController/register'); ?>Choose Admin</a>";
                        }
                    ?>
                    </li>
                    <li class="nav-item">
                    <?php
                        if (!$_SESSION['user']->isGuest) {
                          echo "<a class='nav-link' href='<?php echo site_url('UserController/register'); ?>Choose Highlighted Decks</a>";
                        }
                    ?>
                    </li>
                    <li class="nav-item">
                    <?php
                        if (!$_SESSION['user']->isGuest) {
                          echo "<a class='nav-link' href='<?php echo site_url('UserController/register'); ?>Logout</a>";
                        }
                    ?>
                    </li>
                </ul>
